	...
	<body>
		...
		<div id="show-company" class="content scaffold-show" role="main">
			...
			<ol class="property-list company">
				...
				<g:if test="${companyInstance?.image}">
				<li class="fieldcontain">
					<span id="image-label" class="property-label"><g:message code="company.image.label" default="Image" /></span>
					
						<span class="property-value" aria-labelledby="image-label"><g:link controller="image" action="show" id="${companyInstance?.image?.id}">${companyInstance?.image?.encodeAsHTML()}</g:link></span>
					
				</li>
				</g:if>
			
				<g:if test="${companyInstance?.size}">
				<li class="fieldcontain">
					<span id="size-label" class="property-label"><g:message code="company.size.label" default="Size" /></span>
					
						<span class="property-value" aria-labelledby="size-label"><g:fieldValue bean="${companyInstance}" field="size"/></span>
