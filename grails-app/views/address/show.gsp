	...
	<body>
		...
		<div id="show-address" class="content scaffold-show" role="main">
			...
			<ol class="property-list address">
				...
				<g:if test="${addressInstance?.specifics}">
				<li class="fieldcontain">
					<span id="specifics-label" class="property-label"><g:message code="address.specifics.label" default="Specifics" /></span>
					
						<span class="property-value" aria-labelledby="specifics-label"><g:fieldValue bean="${addressInstance}" field="specifics"/></span>
				...
				<g:if test="${addressInstance?.streetAddr}">
				<li class="fieldcontain">
					<span id="streetAddr-label" class="property-label"><g:message code="address.streetAddr.label" default="Street Addr" /></span>
					
						<span class="property-value" aria-labelledby="streetAddr-label"><g:fieldValue bean="${addressInstance}" field="streetAddr"/></span>
